...
{
  private final Person person = new Person("Grace", "Hopper", LocalDate.of(1906, Month.DECEMBER, 9));
  ...
  public void checkEqualsMethod()
  {
    ...
    assertAll(() -> assertThat(person, is(equalTo(hopper))), () -> assertThat(person, equalTo(hopper)),
  ...
  public void checkSameInstance()
  {
    ...
    Person copy = new Person("Grace", "Hopper", LocalDate.of(1906, Month.DECEMBER, 9));
  ...
  {
    assertThat(person, hasToString("Person{first='Grace', last='Hopper', dob=1906-12-09}"));
  }
  ...
  {
    Person hopper = new Person(1, "Grace", "Hopper", LocalDate.of(1906, Month.DECEMBER, 9));
