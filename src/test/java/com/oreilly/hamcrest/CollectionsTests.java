...
{
  private final List<String> strings = Arrays.asList("this", "is", "a", "list", "of", "strings");
  ...
  {
    assertThat(strings, contains("this", "is", "a", "list", "of", "strings"));
    assertThat(strings, not(contains("of", "is", "list", "a", "this", "strings")));
  }

  @Test
  public void elementsInAnyOrder()
  {
    assertThat(strings, containsInAnyOrder("a", "is", "list", "of", "strings", "this"));
  }

  @Test
  public void eachWordContainsAOI()
  {
    assertThat(strings, everyItem(anyOf(containsString("a"), containsString("i"), containsString("o"))));
  ...
  public void checkItemsInArray()
  {
    ...
    assertThat(stringArray, arrayContainingInAnyOrder("an", "is", "array", "of", "this", "strings"));
  }
