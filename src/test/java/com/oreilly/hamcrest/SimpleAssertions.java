...
public class SimpleAssertions
{
  ...
  public void orderingOnComparable()
  {
    ...
    Person lovelace = new Person(2, "Ada", "Lovelace", LocalDate.of(1815, Month.DECEMBER, 10));
  ...
  {
    Person hopper1 = new Person(1, "Grace", "Hopper", LocalDate.of(1906, Month.DECEMBER, 9));
    Person hopper2 = new Person(1, "Grace", "Hopper", LocalDate.of(1906, Month.DECEMBER, 9));
  ...
  public void nullability()
  {
    ...
    hopper = new Person(1, "Grace", "Hopper", LocalDate.of(1906, Month.DECEMBER, 9));
