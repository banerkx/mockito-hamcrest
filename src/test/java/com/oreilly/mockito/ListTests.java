...
public class ListTests
{
  ...
  public void stubbedList()
  {
    ...
    // If your code cares what get(0) returns, then something else breaks (often even before verify()
    // gets executed).
    // If your code doesn't care what get(0) returns, then it should not be stubbed. Not convinced? See
    // here.
  ...
  public void chainedMethodCalls()
  {
    ...
    when(mockedList.get(anyInt())).thenReturn(0)  // first call to get returns 0
  ...
  public void chainedMethodCallsAsArguments()
  {
    ...
    when(mockedList.size()).thenReturn(0, 1, 2);
  ...
  public void argumentMatchers()
  {
    ...
    IntStream.rangeClosed(1, 1000).forEach(x -> assertThat("element", is(mockedList.get(x))));
  ...
  public void verifyOrdering()
  {
    ...
    // following will make sure that add is first called with "was added first", then with "was added
    // second"
