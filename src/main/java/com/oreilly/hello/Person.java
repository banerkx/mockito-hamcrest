...
// public record Person(Integer id, String first, String last, LocalDate dob) implements
// Comparable<Person> {
...
public class Person implements Comparable<Person>
{
  ...
  public boolean equals(Object o)
  {
    ...
    return Objects.equals(first, person.first) && Objects.equals(last, person.last) && Objects.equals(dob, person.dob);
  }
  ...
  {
    return "Person{" + "first='" + first + '\'' + ", last='" + last + '\'' + ", dob=" + dob + '}';
  }
}
